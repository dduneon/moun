...
def seed():
    ...
    try:
        ...
        def tx(name, amount, cat_name, tx_date, card=None, memo=None,
            ...
            spend_cycle = cycle if t_date >= date(2026, 6, 1) else prev_cycle
            billing_cycle = cycle if billing_date >= date(2026, 6, 1) else prev_cycle
        ...
        transactions_data = [
            tx("스타벅스 강남점", -6500, "카페", date(2026, 6, 1), shinhan, "아메리카노"),
            tx("대중교통", -1450, "교통", date(2026, 6, 2), method=PaymentMethod.account),
            tx("이마트", -78000, "식비", date(2026, 6, 3), shinhan),
            tx("올리브영", -71000, "쇼핑", date(2026, 6, 4), kb),
            tx("CU 편의점", -4200, "식비", date(2026, 6, 5), shinhan),
            tx("대중교통", -1450, "교통", date(2026, 6, 6), method=PaymentMethod.account),
            tx("CGV", -15000, "문화", date(2026, 6, 7), kb),
            tx("점심 식사", -12000, "식비", date(2026, 6, 8), shinhan, "삼겹살"),
            tx("스타벅스", -6000, "카페", date(2026, 6, 9), shinhan),
            tx("쿠팡", -34500, "쇼핑", date(2026, 6, 10), kb),
            tx("대중교통", -1450, "교통", date(2026, 6, 11), method=PaymentMethod.account),
            tx("한식당", -9000, "식비", date(2026, 6, 12), shinhan),
            tx("배달의민족", -28000, "식비", date(2026, 6, 13), kb),
            tx("대중교통", -1450, "교통", date(2026, 6, 14), method=PaymentMethod.account),
            tx("스타벅스", -5500, "카페", date(2026, 6, 15), shinhan, "라떼"),
            tx("대중교통", -1450, "교통", date(2026, 6, 16), method=PaymentMethod.account),
            tx("교보문고", -18000, "문화", date(2026, 6, 17), kb),
            tx("편의점", -3200, "식비", date(2026, 6, 18), shinhan),
            tx("이마트", -65000, "식비", date(2026, 6, 19), shinhan),
